	...
	<div class="caja_popup2">
		<form class="contenedor_popup" method="POST">
			<table>
				...
				<tr>
					<td>Correo</td>
					<td><input class="CajaTexto" type="email" name="txtcorreo" value="<?php echo $usucorreo; ?>"
							readonly></td>
				</tr>
				<tr>
					<td>Password</td>
					<td><input class="CajaTexto" type="password" name="txtpass" value="<?php echo $pass; ?>" required>
					</td>
				</tr>
				<tr>

					<td colspan="2">
						<?php echo "<a class='BotonesUsuarios' href=\"listado_usuarios.php?pag=$pagina\">Cancelar</a>"; ?>
						<input class="BotonesUsuarios" type="submit" name="btnmodificar" value="Actualizar"
...
if (isset($_POST['btnmodificar'])) {
	...
	echo "<script>window.location= 'listado_usuarios.php?pag=$pagina' </script>";
